...
-------------------------------------------------------------------
  ...
  - 3 years of experience with Python, R & Git

  - 3 years of experience with RMarkdown (now Quarto) & LaTeX

  - 1 year of experience with SQL (SQLite)

  - 6 months of experience with Typescript & Javascript

  - CI/CD (GitHub Actions / GitLab CI) & Docker

  - Backend Development in Python with `FastAPI`
