...
output:
  pagedown::html_resume:
    css: ["multipage.css", "shared.css", "resume"]
    self_contained: TRUE
...
-------------------------------------------------------------------
  ...
  - 3 Jahre Erfahrung mit Python, R & Git

  - 3 Jahre Erfahrung mit RMarkdown (jetzt Quarto) & LaTeX

  - 1 Jahr Erfahrung mit SQL (SQLite)

  - 6 Monate Erfahrung mit Typescript & Javascript

  - CI/CD (Github Actions, GitLab CI) & Docker

  - Backend Entwicklung in Python mit `FastAPI`
